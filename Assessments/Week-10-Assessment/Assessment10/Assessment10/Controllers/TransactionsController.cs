...
namespace Assessment10.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public TransactionsController(Assessment10Context context)
        {
            _context = context;
        }
        ...
        {
            var assessment10Context = _context.Transaction.Include(t => t.Account);
            return View(await assessment10Context.ToListAsync());
        }
