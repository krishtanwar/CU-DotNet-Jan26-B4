...
namespace ValidationProject.Repositories
{
    ...
    {
        private readonly ValidationProjectContext _context;

        public CourseRepo(ValidationProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<Course> Update(Course c)
        {
            ...
            cour.Title = c.Title;
            cour.Price = c.Price;
            cour.Description = cour.Description;
            cour.Duration = cour.Duration;
