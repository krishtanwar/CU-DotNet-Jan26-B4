...
namespace Car_Management_MVC_Application.Controllers
{
    public class CarsController : Controller
    {
        private readonly Car_Management_MVC_ApplicationContext _context;

        public CarsController(Car_Management_MVC_ApplicationContext context)
        {
            _context = context;
        }
