...
using Day60Assignment01.ViewModels;

namespace Day60Assignment01.Controllers
{
    public class InvestmentsController : Controller
    {
        private readonly Day60Assignment01Context _context;

        public InvestmentsController(Day60Assignment01Context context)
        {
            _context = context;
        }
